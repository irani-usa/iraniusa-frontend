  ...
  return (
    <>
      ...
      <section className='container  py-9 lg:py-20 lg:flex lg:flex-col lg:items-center contact'>
        <h1 className='text-black font-bold text-3xl text-center font-outfit'>Contact us</h1>
        <p className='text-white-shade-9 font-opensans text-center py-7'>
          Ask about our platform, pricing, implementation or anything else. Our highly
          <br />
        ...
        <div className='flex flex-col gap-y-4 lg:flex-row gap-x-7'>
          ...
          <div className='flex gap-x-3 items-center font-opensans py-2 px-2 rounded-full   boreered lg:pr-28'>
            ...
            <div>
              ...
              <h2 className='text-black font-semibold text-lg'>(603) 555-0123</h2>
            </div>
          </div>
        </div>
