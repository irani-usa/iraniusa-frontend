...
const page = () => {
  return (
    ...
    <section className='container py-12 lg:flex justify-between'>
     ...
     <h1 className='text-black text-2xl text-center font-semibold font-outfit'>Forgot password?</h1>
        <h2 className='text-white-shade-8 text-center text-lg py-2 font-opensans'>No worreis, we will send you reset email</h2>
        <form action="#" className='flex flex-col gap-y-5 py-10'>
            ...
            <Button content={'Reset password'} classes={'bg-blue py-4 lg:bg-black'} />
        </form>
        <h1 className='text-black font-opensans font-medium text-lg text-center'>Back to login page</h1>
     </section>
