...
const page = () => {
    return (
        <>
            <div className="w-full lg:flex lg:flex-row-reverse container lg:items-start gap-x-10 mt-10">
                <section className="lg:pr-5  w-full">
                    <div className='w-full flex justify-between lg:flex-row flex-col gap-2'>
                        ...
                        <div className="flex items-center gap-1">
                            <label htmlFor="HeadlineAct" className="hidden lg:block w-1/2 text-sm font-medium "> Sort by:    </label>

                            <select
                                name="HeadlineAct"
                                id="HeadlineAct"
                                className="px-5 bg-white-shade-4 py-3 w-full rounded-lg border-white-shade-4 text-black text-xl sm:text-sm focus:border-none"
                            >
                    ...
                    <div className="whitespace-nowrap no-scroll overflow-x-auto flex gap-10  p-6 lg:grid lg:grid-cols-2 w-full justify-between">
                ...
                <section className="lg:pl-5 lg:w-1/3">
