...
const ToursCard: React.FC<ToursCardProps> = (props) => {
    return (
        <div className="relative top-0 left-0 w-full border-white-shade-4 border rounded-2xl hover:shadow-card transition-all duration-300 hover:z-50 hover:-top-5 hover:cursor-pointer">
            ...
            <div className="grid grid-cols-2 grid-row-2 gap-y-3 font-opensans mx-4 mt-12 mb-6">
                ...
                <div className="flex items-center font-semibold gap-x-2">
                    <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6 12.329C6 8.28129 9.13401 5 13 5C16.866 5 20 8.28129 20 12.329C20 16.3449 17.7658 21.0312 14.2801 22.707C13.4675 23.0977 12.5325 23.0977 11.7199 22.707C8.23416 21.0312 6 16.3449 6 12.329Z" stroke="#B3B3B3" strokeWidth="1.33984" />
                        <path d="M11 12H16" stroke="#B3B3B3" strokeWidth="1.33984" strokeLinecap="round" />
                    </svg>
                    <span className="text-black">
                        {props.location}
                    </span>
                ...
                <div className="flex items-center font-semibold gap-x-2">
                    <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd" clipRule="evenodd" d="M14 5.39535C9.24778 5.39535 5.39535 9.24778 5.39535 14C5.39535 18.7522 9.24778 22.6047 14 22.6047C18.7522 22.6047 22.6047 18.7522 22.6047 14C22.6047 9.24778 18.7522 5.39535 14 5.39535ZM4 14C4 8.47715 8.47715 4 14 4C19.5228 4 24 8.47715 24 14C24 19.5228 19.5228 24 14 24C8.47715 24 4 19.5228 4 14ZM14 9.5814C14.3853 9.5814 14.6977 9.89375 14.6977 10.2791V13.711L16.8189 15.8323C17.0914 16.1047 17.0914 16.5465 16.8189 16.8189C16.5465 17.0914 16.1047 17.0914 15.8323 16.8189L13.5067 14.4933C13.3758 14.3625 13.3023 14.185 13.3023 14V10.2791C13.3023 9.89375 13.6147 9.5814 14 9.5814Z" fill="#B3B3B3" />
                    </svg>
                    <span className="text-black">
                        {props.duration}
                    </span>
