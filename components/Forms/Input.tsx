        ...
        <>
            ...
            <div>
                ...
                <div className={`${props.classes} border border-white-shade-4 text-black font-opensans flex items-center gap-x-4 text-lg font-medium rounded-xl w-full h-16 px-4`}>
                    {props.iconComp}
                    <input className={`${props.classes} text-white-shade-15 text-sm w-full h-full rounded-xl bg-transparent focus:outline-hidden focus:shadow-none`} id={props.id} type={props.inputType} placeholder={props.placeHolder} />
                </div>
            </div>
        </>
    )
