...
const NormallBanner: React.FC<NormallBanner> = (props) => {
  return (
    ...
    <Link href={'/'} className='relative flex flex-col items-center justify-center gap-y-5 w-full py-10 h-auto bg-cover bg-center rounded-2xl hover:cursor-pointer box' style={{ backgroundImage: `url('/images/banner/3.png')` }}>
