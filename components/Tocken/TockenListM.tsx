...
const TockenListM: React.FC<TockenListM> = (props) =>{
  return (
    <>
    <div className='flex flex-col gap-y-4 border-b-[1.5px] border-b-[#E6E8EC] pb-7 lg:hidden mt-6
    '>
