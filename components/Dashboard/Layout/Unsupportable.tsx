...
const Unsupportable = () => {
  return (
    <section
      className="flex flex-col justify-center-center w-full h-screen  bg-cover bg-center lg:hidden"
      style={{ backgroundImage: `url('/images/dashboard/bg.webp')` }}
    >
      <div className="container flex flex-col items-center justify-center gap-y-5 h-full">
        <svg
          width="42"
          height="60"
          viewBox="0 0 42 60"
