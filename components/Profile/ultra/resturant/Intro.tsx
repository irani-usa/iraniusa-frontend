      ...
      <section className="container  lg:px-2">
        <div className="bg-white-shade-2 p-2 w-full pb-2 rounded-3xl lg:flex lg:pb-0 h-auto">
          <div className="w-full p-6 flex flex-col gap-y-5 rounded-3xl lg:w-1/2">
            ...
            <div className='w-full flex flex-col gap-y-4  pt-8 pb-5 lg:pt-12'>
              <div className='flex flex-col gap-y-4  lg:grid lg:grid-cols-5 gap-x-4'>
                <Option title={'Open from 10 am to 23 pm'} bgColor={'green/10'} textColor={'green'} Icon={undefined} size={'3'} />
                <Option title={'All times'} bgColor={'green'} textColor={'white'} Icon={<Store />} size={'2'} />
              </div>
              <div className='flex flex-col gap-y-4 lg:grid lg:grid-cols-6 gap-x-4'>
                <Option title={'Lunch time on fri-tue-sat'} bgColor={'green/10'} textColor={'lightblue'} Icon={undefined} size={'3'} />
                <Option title={'from 12pm to 2pm'} bgColor={'green/10'} textColor={'lightblue'} Icon={<Clock />} size={'3'} />
              </div>
            </div>

          </div>
          <div
            className="w-full  lg:w-1/2 h-[450px] bg-cover bg-center lg:h-[520px] rounded-2xl"
            style={{
