...
const UserTitle = () => {
  return (
    <div className='flex flex-col gap-y-2 mt-16 lg:gap-y-0 '>
      <h1 className='text-black font-outfit font-semibold text-xl lg:ml-2'>Amin gholami</h1>
      <div className='w-full flex items-center font-medium gap-x-6 text-white-shade-9 font-opensans lg:text-lg'>
        <span >Product designer</span>
        <span className='flex items-center gap-x-2 lg:hidden'><svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
