...
const Avatar: React.FC<AvatarProps> = (props) => {
  return (
    <>
      ...
      ></div>
{ props.Contact &&     <div className="flex items-center gap-x-2 absolute top-[115px] right-[4%]">
        ...
        <button
          className="bg-blue font-opensans py-2 rounded-xl lg:rounded-2xl px-6 lg:py-3 lg:px-10"
          type="button"
        >
          Contact
        </button>
