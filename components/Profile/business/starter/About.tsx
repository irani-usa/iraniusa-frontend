    ...
    <section className=' border-b border-white-shade-4 py-8 container'>
      <div className=' lg:pl-6'>
        <div className="py-7 flex flex-col gap-y-6 items-center">
          ...
          <h1 className="text-black font-medium tex-2xl lg:text-3xl font-outfit ">
            {props.title}
          </h1>
          <p className=" text-white-shade-9  font-opensans text-center">
            {props.about}
          </p>
          <p className="text-lg text-black font-semibold font-opensans text-center border border-white-shade-4 w-max px-5 py-1 rounded-lg my-5 flex items-center gap-2">
