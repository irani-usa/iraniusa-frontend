...
const MembersCard: React.FC<MembersCardProps> = (props) => {
  return (
    ...
    className={`${props.class} w-full h-64 bg-center bg-cover rounded-2xl flex flex-col p-5 items-start justify-end gap-y-1 mt-8 lg:max-w-[20%] lg:p-4 lg:h-60 lg:mt-0`}  >
