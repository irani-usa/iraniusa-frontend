...
<div
      className={`${props.class} group cursor-pointer  p-5 border border-white-shade-4 flex flex-col gap-y-5 justify-between rounded-2xl my-6  lg:gap-y-8`}
    >
      <span className="text-white-shade-8 flex items-center gap-x-5 text-xl font-semibold pl-3 group-hover:text-black duration-200">
        <svg
          width="29"
          height="35"
          viewBox="0 0 29 35"
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd" className="group-hover:fill-black"
      ...
      <p className="text-white-shade-8 group-hover:text-black duration-200 ">{props.descreption}</p>
    </div>
    <div className='w-0 group-hover:w-20 duration-300 absolute bottom-7 rounded-full h-1 bg-red'></div>
</div>
  );
};
