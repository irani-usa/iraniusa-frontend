         ...
         
           {
            features.map(
              (
                ...
                return <li className="flex gap-2 items-center font-semibold text-black text-sm"><svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
