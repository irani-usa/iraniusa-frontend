            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full container mt-10">
                ...
                <div>
                    ...
                    <div className="space-y-4 ">
                        <div className="h-64 p-4 shadow flex rounded-2xl relative text-white">
                        ...
                        <div className="p-4 h-28 shadow flex rounded-2xl relative text-white">
                ...
                <div>
                    ...
                    <div className="bg-primary-shade-11 text-white rounded-2xl shadow  flex flex-col gap-3 p-2">
                        {songs.map((song, index) => (
                            ...
                            >
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M9 0.25C9.41421 0.25 9.75 0.585786 9.75 1L9.75 17C9.75 17.4142 9.41421 17.75 9 17.75C8.58579 17.75 8.25 17.4142 8.25 17L8.25 1C8.25 0.585786 8.58579 0.25 9 0.25ZM5 3.25C5.41421 3.25 5.75 3.58579 5.75 4V14C5.75 14.4142 5.41421 14.75 5 14.75C4.58579 14.75 4.25 14.4142 4.25 14V4C4.25 3.58579 4.58579 3.25 5 3.25ZM13 3.25C13.4142 3.25 13.75 3.58579 13.75 4V14C13.75 14.4142 13.4142 14.75 13 14.75C12.5858 14.75 12.25 14.4142 12.25 14V4C12.25 3.58579 12.5858 3.25 13 3.25ZM1 7.25C1.41421 7.25 1.75 7.58579 1.75 8L1.75 10C1.75 10.4142 1.41421 10.75 1 10.75C0.585787 10.75 0.25 10.4142 0.25 10L0.25 8C0.25 7.58579 0.585786 7.25 1 7.25ZM17 7.25C17.4142 7.25 17.75 7.58579 17.75 8V10C17.75 10.4142 17.4142 10.75 17 10.75C16.5858 10.75 16.25 10.4142 16.25 10V8C16.25 7.58579 16.5858 7.25 17 7.25Z" fill="black"/>
                                </svg>
                ...
                <div>
                    ...
                    <div className="bg-primary-shade-11 text-white shadow  h-full p-2 rounded-2xl w-full flex flex-col justify-between">
