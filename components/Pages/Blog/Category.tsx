...
const Category: React.FC<CategoryProps> = (props) => {
  return (
   ...
   <div className='py-5 border-b-[1.5px] text-white-shade-9  border-white-shade-4 hover:scale-105 hover:text-black hover:font-semibold transition-all duration-500'>
        <span className='flex items-center  justify-between font-opensans '>{props.content} <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
