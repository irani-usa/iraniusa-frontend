...
const BlogCardM: React.FC<BlogCardMProps> = (props) => {
  return (
    <>
      <Link href={"#"} className="profileBlogCard">
        <div
          className={`${props.classes} rounded-2xl border-[1.5px] border-white-shade-3 hover:shadow-card transition-all duration-300`}
        >
          <Image
            className="w-full rounded-t-2xl"
            src={"/images/blog/UsaFlag.webp"}
            width={300}
            height={300}
            alt={""}
          />
          <div className="flex flex-col gap-y-4">
            <h1 className="px-6 pt-6  text-black text-xl font-outfit font-semibold">
              Exploring Shirez Canyon in the Heart of Zagros Mountains
            </h1>
            <p className="px-6  font-opensans text-white-shade-10 font-medium">
              Shirez Canyon: A Natural Wonder in the Heart of Zagros
              Mountains...
            </p>
